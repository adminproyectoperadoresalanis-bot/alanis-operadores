...
function mostrarResultadoDoc(resultado) {
  ...
  // ya NO se muestra en esta pantalla de aviso de Checkpoint 1 — ajustado
  // esa misma noche por petición de Ivan. El QR de intercambio se sigue
  // ofreciendo correctamente como tarjeta en la sección Documentación,
  // justo después de completar Checkpoint 1. Se deja el elemento en el
  // HTML por si se necesita en otro lado, pero esta función siempre lo
  // oculta.
